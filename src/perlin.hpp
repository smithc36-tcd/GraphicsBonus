/*
 * Implemented using http://adrianb.io/2014/08/09/perlinnoise.html
 * to create the perlin function
 */
...
private:
  ...
  std::vector<int> get_permuation_vector();

  // Hash lookup table as defined by Ken Perlin.
  // This is a randomly arranged array for all numbers from
  // 0 - 255 inclusive
